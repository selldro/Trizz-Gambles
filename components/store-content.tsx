      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {storeItems.map((item) => (
          ...
          >
            ...
            {/* Empty Area */}
            <div className="h-40 bg-gradient-to-br from-[#0a0a0a] to-[#111111]" />

            {/* Cost */}
            <div className="flex items-center gap-1.5 px-4 py-3 border-t border-[#1a1a1a]">
            ...
            <div className="px-4 pb-4">
              {item.status === "in_stock" ? (
                <button className="w-full py-2 rounded-md bg-gradient-to-b from-[#00ff87] to-[#00cc6a] text-black text-[11px] font-bold tracking-[0.18em] hover:opacity-90 transition-opacity">
                  REDEEM
                </button>
              ) : (
                <button disabled className="w-full py-2 rounded-md bg-[#1a1a1a] text-[#555555] text-[11px] font-bold tracking-[0.18em] cursor-not-allowed">
                  OUT OF STOCK
                </button>
              )}
            </div>
