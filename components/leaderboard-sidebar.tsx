...
export function LeaderboardSidebar() {
  return (
    <aside className="rounded-xl bg-[#0f0f0f] border border-[#1a1a1a] p-5">
      {/* How it works */}
      <div className="flex items-center gap-2">
        <span className="grid place-items-center w-7 h-7 rounded-md bg-[#1a1a1a] border border-[#1a1a1a]">
      ...
      <ol className="mt-5 relative">
          ...
          <li key={s.n} className="relative pl-12 pb-6 last:pb-0">
            ...
            <span className="absolute left-0 top-0 grid place-items-center w-7 h-7 rounded-full bg-[#1a1a1a] border border-[#252525] text-[11px] font-bold text-[#00ff87]">
              {s.n}
            </span>
