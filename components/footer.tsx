      ...
      <section className="rounded-xl bg-[#1a1f3a] border border-[#2a344a] card-glow p-5 mt-5 mb-5">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Discord Icon */}
            <a href="https://discord.gg/vZEb5KuG9q" target="_blank" rel="noopener noreferrer" className="grid place-items-center w-8 h-8 rounded-md bg-[#1a1f3a] border border-[#2a344a] hover:bg-[#1a1f3a] transition-colors">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="#0969b7">
