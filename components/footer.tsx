...
=======
      <section className="rounded-xl bg-[#120b26] border border-[#1a1033] p-5 mt-5 mb-5">
...
=======
            <a href="https://x.com/zyynvlr" target="_blank" rel="noopener noreferrer" className="grid place-items-center w-8 h-8 rounded-md bg-[#1a1033] border border-[#1a1033] hover:bg-[#1a1033] transition-colors">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="#8b3dff">
>>>>>>> 0ab98f1026ba421f87062ada3c6c0abbd3abafff
            ...
            {/* Discord Icon */}
            <a href="https://discord.gg/zyyn" target="_blank" rel="noopener noreferrer" className="grid place-items-center w-8 h-8 rounded-md bg-[#1a1033] border border-[#1a1033] hover:bg-[#1a1033] transition-colors">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="#8b3dff">
...
<<<<<<< HEAD
            <a href="https://kick.com/trizzgamba" target="_blank" rel="noopener noreferrer" className="grid place-items-center w-8 h-8 rounded-md bg-[#1a1f3a] border border-[#2a344a] hover:bg-[#1a1f3a] transition-colors">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="#0969b7">
=======
            <a href="https://kick.com/zyynvlr" target="_blank" rel="noopener noreferrer" className="grid place-items-center w-8 h-8 rounded-md bg-[#1a1033] border border-[#1a1033] hover:bg-[#1a1033] transition-colors">
              <svg viewBox="0 0 24 24" className="w-4 h-4" fill="#8b3dff">
>>>>>>> 0ab98f1026ba421f87062ada3c6c0abbd3abafff
