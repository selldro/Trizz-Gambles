  ...
  return (
    <section className="rounded-xl bg-[#0f0f0f] border border-[#1a1a1a] p-6 mt-5">
      ...
      <div className="flex justify-center py-10">
        <div className="w-full max-w-[460px] rounded-md bg-[#0a0a0a] border border-[#1a1a1a] p-8 flex flex-col items-center text-center">
          <div className="grid place-items-center w-14 h-14 rounded-md bg-[#1a1a1a] border border-[#00ff87]/30 mb-4">
